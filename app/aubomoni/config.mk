...
C_CFLAGS += -I./ -I/usr/include/ -I$(BASE)/thrdprty/include/openni2 -I$(BASE)/sys/utils
C_CFLAGS += -I./graph
...
LDFLAGS += -lc -lm -lopencv_core -lopencv_highgui -fpic -lcore -lopencv_imgproc -lopencv_contrib -lhal -lsys
