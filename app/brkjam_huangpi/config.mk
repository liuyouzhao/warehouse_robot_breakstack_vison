...
OUT_BIN = bjam_huangpi

# compiling and linking flags
C_CFLAGS += -I./ -I/usr/include/ -I$(BASE)/thrdprty/include/openni2
C_CFLAGS += -I./graph
C_CFLAGS += -I$(BASE)/include -I$(BASE)/core/VisionTool
C_CFLAGS += -I$(BASE)/include/hal -I$(BASE)/core/Segmentation3D
C_CFLAGS += -I$(BASE)/hal/camera -I$(BASE)/hal -I$(BASE)/camera/cam3d
C_CFLAGS += -I$(BASE)/sys/utils
C_CFLAGS += -I$(BASE)/sys
C_CFLAGS += -I$(BASE)/core/recognition
...
LDFLAGS += -lc -lm -lopencv_core -lopencv_highgui -fpic -lcore -lopencv_imgproc -lopencv_contrib -lsys -lhal -lcore_rcgnt
