...
C_CFLAGS += -I./ -I$(BASE)/thrdprty/include/openni2 -I$(BASE)/include/hal -I$(BASE)/include -I$(BASE)
C_CFLAGS += -I./graph
C_CFLAGS += -fPIC -gdwarf-3
...
## normal
LDFLAGS += -L$(BASE)/libs -gdwarf-3
LDFLAGS += -lc -lm -lGL -lX11 -lOpenNI2 -lglut  -fpic -lsys \
          -shared
